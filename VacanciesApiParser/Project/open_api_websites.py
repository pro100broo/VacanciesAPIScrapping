...
class OpenApiWebsitesParser(GenericParser):
    ...
    def get_vacancies(self, pages_count: int, keywords: list[str], website: str) -> list[Vacancy]:
        ...
        for page in range(1, pages_count + 1):
            url = f"https://api.{website}.ru/vacancies?text={content}&page={page}"
    ...
    def parse_vacancy(self, vacancy_info: dict) -> Vacancy:
        ...
        return Vacancy(
            ...
            description=vacancy_info["snippet"]["requirement"] if vacancy_info["snippet"]["requirement"] else "No info",
            salary=Salary(
